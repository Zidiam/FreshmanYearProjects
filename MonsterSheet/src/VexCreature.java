/*
 * VexCreature.java -- Represents a Vex creature with the same characteristics as a Vex species!
 * You can get and set different types of characteristics of a Vex creature including type.
 * Jason Melnik
 * 2/09/2019
 */
import javax.swing.ImageIcon;

public class VexCreature extends Vex {
	private static String type;
	private String noise, weight, speed, skills, weapon, url;
	
	public VexCreature(String type) {
		super(type);
		this.type = type;
		noise = "";
		weight = "";
