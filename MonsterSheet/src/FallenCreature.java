/*
 * FallenCreature.java -- Represents a Fallen creature with the same characteristics as a Fallen species!
 * You can get and set different types of characteristics of a Fallen creature including type.
 * Jason Melnik
 * 2/09/2019
 */
import javax.swing.ImageIcon;

public class FallenCreature extends Fallen {
	private static String type;
	private String noise, weight, speed, skills, weapon, url;
	
	public FallenCreature(String type) {
		super(type);
		this.type = type;
		noise = "";
		weight = "";
