...
public class SnakeGamePanel extends JPanel{
	...
	public void ImageLoader() {
		squareImg = new ImageIcon(location + "Images\\square.png");
		appleImg = new ImageIcon(location + "Images\\apple.png");
		grassImg = new ImageIcon(location + "Images\\grass.png");
		mouthOpenRightImg = new ImageIcon(location + "Images\\mouthOpenRight.png");
		mouthOpenLeftImg = new ImageIcon(location + "Images\\mouthOpenLeft.png");
		mouthOpenUpImg = new ImageIcon(location + "Images\\mouthOpenUp.png");
		mouthOpenDownImg = new ImageIcon(location + "Images\\mouthOpenDown.png");
		snakeDownImg = new ImageIcon(location + "Images\\snakeDown.png");
		snakeLeftImg = new ImageIcon(location + "Images\\snakeLeft.png");
		snakeRightImg = new ImageIcon(location + "Images\\snakeRight.png");
		snakeUpImg = new ImageIcon(location + "Images\\snakeUp.png");
		tailDownImg = new ImageIcon(location + "Images\\tailDown.png");
		tailUpImg = new ImageIcon(location + "Images\\tailUp.png");
		tailRightImg = new ImageIcon(location + "Images\\tailRight.png");
		tailLeftImg = new ImageIcon(location + "Images\\tailLeft.png");
		backgroundImg = new ImageIcon(location + "Images\\background.png");
	}
	...
	public void paintComponent(Graphics page)
	{
		...
		if (gameOver == true) {
	        ...
	        g2.drawString("Made by Jason Melnik", WIDTH/2, HEIGHT/2 + 48); 
		}
	}
