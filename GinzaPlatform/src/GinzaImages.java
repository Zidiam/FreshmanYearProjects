...
public class GinzaImages {
	...
	public GinzaImages(){
		ImageIcon test = new ImageIcon("src\\PlatForm_Resources\\Images\\standingStill.png");
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\standingStill.png");
		img = test.getImage();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\grass.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\metal.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, Character_Size_Width, Character_Size_Width, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\smallSaw.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, Character_Size_Width, Character_Size_Width, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\bigSaw.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\menuScreen.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\levelSelectBackground.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 12, 12, 1020, 516, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\playButton.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\light_gray.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, Character_Size_Width, Character_Size_Width, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\sky.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, Character_Size_Width, Character_Size_Width, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\lock.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\bloodSpatter.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\bloodBlock.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, Character_Size_Width, Character_Size_Width, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\brownBlock.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, Character_Size_Width, Character_Size_Width, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\enemyImg.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, Character_Size_Width, Character_Size_Height, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\VolumeButton.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, 25, 25, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\MuteButton.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, 25, 25, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\settingSelect.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, 250, 50, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\0Star.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\1Star.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, 250, 75, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\2Star.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, 250, 75, null);
		...
		test = new ImageIcon("src\\PlatForm_Resources\\Images\\3Star.png");
		img = test.getImage();
		bi = new BufferedImage(img.getWidth(null), img.getHeight(null), BufferedImage.TYPE_INT_ARGB);
		g = bi.createGraphics();
		g.drawImage(img, 0, 0, 250, 75, null);
