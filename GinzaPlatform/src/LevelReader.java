...
{ 
  ...
  public void setupLevelReader(String fileN) throws IOException{
	  ...
	  t = "";
	  File file = new File("src\\PlatForm_Resources\\Levels\\" + fileN + ".txt"); 
  ...
  private void creator(String fileN) throws IOException{
	  File file = new File("src\\PlatForm_Resources//Levels//" + fileN + ".txt");
	     ...
	     file = new File("src\\PlatForm_Resources//Levels//" + fileN + ".txt");
  ...
  public void fileremove(String remove) throws IOException{
	  ...
	  File file = new File("src\\PlatForm_Resources//Levels//" + filename + ".txt");
	  file.delete();
	  
	  file = new File("src\\PlatForm_Resources//Levels//" + filename + ".txt");
	  file.createNewFile();
