...
public class GinzaMenuScreen {
	...
	public GinzaMenuScreen(GinzaPanel environment) {
		...
		playButton = new JButton(new ImageIcon("src\\PlatForm_Resources//Images//playButton.png"));
		levelSelectButton = new JButton(new ImageIcon("src\\PlatForm_Resources//Images//levelSelect.png"));
		//settingsSelectButton = new JButton(new ImageIcon("Images//settingSelect.png"));
