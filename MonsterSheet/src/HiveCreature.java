/*
 * HiveCreature.java -- Represents a hive creature with the same characteristics as a Hive species!
 * You can get and set different types of characteristics of a hive creature including type.
 * Jason Melnik
 * 2/09/2019
 */
import javax.swing.ImageIcon;
public class HiveCreature extends Hive {
	private static String type;
	private String noise, weight, speed, skills, weapon, url;
	
	public HiveCreature(String type) {
		super(type);
		this.type = type;
		noise = "";
		weight = "";
